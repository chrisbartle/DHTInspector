...
The detail behind [the README](README.md): what the engine and each
measurement actually do, how the source is laid out, and how builds,
tests and releases work.
...
- Suspicious groups, over answering nodes, as leads rather than verdicts:
  ...
  showing two or more signals are listed first. Every group has a link that
  filters the node list to it.
